...
delete_box = Entry(root, width=30, bg='yellow')
...
delete_lable=label = Label(root, text='Delete ID')
delete_lable.grid(row=9, column=0)
...
delete_button = Button(root, text='Delete', command=delete ,bg='purple', fg='red')
delete_button.grid(row=10, column=0, columnspan=2, padx=10, pady=10, ipadx=120)
